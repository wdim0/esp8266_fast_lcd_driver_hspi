...
//---- more complete definition added by wdim ("pin_mux_register.h" from RTOS used)
//(why Espressif doesn't expose everything about the ESP8266 chip?)
...
//one more parentheses added by wdim to get rid of compiler (and eclipse's) warning
